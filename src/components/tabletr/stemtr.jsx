...
const Stemtr = ({customName, index, bill ,change, deleted, data }) => {
    ...
    return (
        ...
        <tr className="team-table-row team-table-row-1"  id = {`${customName}-row-${index+1}`} style={{ display : `${value.status === undefined ? '' : 'none'}`}} >
            ...
            <td> <input name = {`${customName}${index+1}`} required type="text" id= "linkedin" onChange = {change} value = {value.linkedin || ""} /> </td>
